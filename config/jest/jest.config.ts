...
export default {
  ...
  // A map from regular expressions to module names or tth a single module
  // moduleNameMapper: {},

  // An array of regexp pattern strings, matched against all  'visible' to the module loader
